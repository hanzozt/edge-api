...
// bindHeaderPatchRouterOK binds the response header WWW-Authenticate
func (o *PatchRouterOK) bindHeaderWWWAuthenticate(hdr string, formats strfmt.Registry) ([]string, error) {
...
// bindHeaderPatchRouterBadRequest binds the response header WWW-Authenticate
func (o *PatchRouterBadRequest) bindHeaderWWWAuthenticate(hdr string, formats strfmt.Registry) ([]string, error) {
	wWWAuthenticateIV := hdr
...
// bindHeaderPatchRouterUnauthorized binds the response header WWW-Authenticate
func (o *PatchRouterUnauthorized) bindHeaderWWWAuthenticate(hdr string, formats strfmt.Registry) ([]string, error) {
	wWWAuthenticateIV := hdr
...
// bindHeaderPatchRouterNotFound binds the response header WWW-Authenticate
func (o *PatchRouterNotFound) bindHeaderWWWAuthenticate(hdr string, formats strfmt.Registry) ([]string, error) {
	wWWAuthenticateIV := hdr
...
// bindHeaderPatchRouterTooManyRequests binds the response header WWW-Authenticate
func (o *PatchRouterTooManyRequests) bindHeaderWWWAuthenticate(hdr string, formats strfmt.Registry) ([]string, error) {
	wWWAuthenticateIV := hdr
...
// bindHeaderPatchRouterServiceUnavailable binds the response header WWW-Authenticate
func (o *PatchRouterServiceUnavailable) bindHeaderWWWAuthenticate(hdr string, formats strfmt.Registry) ([]string, error) {
	wWWAuthenticateIV := hdr
