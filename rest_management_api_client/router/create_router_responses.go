...
// bindHeaderCreateRouterCreated binds the response header WWW-Authenticate
func (o *CreateRouterCreated) bindHeaderWWWAuthenticate(hdr string, formats strfmt.Registry) ([]string, error) {
...
// bindHeaderCreateRouterBadRequest binds the response header WWW-Authenticate
func (o *CreateRouterBadRequest) bindHeaderWWWAuthenticate(hdr string, formats strfmt.Registry) ([]string, error) {
	wWWAuthenticateIV := hdr
...
// bindHeaderCreateRouterUnauthorized binds the response header WWW-Authenticate
func (o *CreateRouterUnauthorized) bindHeaderWWWAuthenticate(hdr string, formats strfmt.Registry) ([]string, error) {
	wWWAuthenticateIV := hdr
...
// bindHeaderCreateRouterTooManyRequests binds the response header WWW-Authenticate
func (o *CreateRouterTooManyRequests) bindHeaderWWWAuthenticate(hdr string, formats strfmt.Registry) ([]string, error) {
	wWWAuthenticateIV := hdr
...
// bindHeaderCreateRouterServiceUnavailable binds the response header WWW-Authenticate
func (o *CreateRouterServiceUnavailable) bindHeaderWWWAuthenticate(hdr string, formats strfmt.Registry) ([]string, error) {
	wWWAuthenticateIV := hdr
