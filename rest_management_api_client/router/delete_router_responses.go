...
// bindHeaderDeleteRouterOK binds the response header WWW-Authenticate
func (o *DeleteRouterOK) bindHeaderWWWAuthenticate(hdr string, formats strfmt.Registry) ([]string, error) {
...
// bindHeaderDeleteRouterBadRequest binds the response header WWW-Authenticate
func (o *DeleteRouterBadRequest) bindHeaderWWWAuthenticate(hdr string, formats strfmt.Registry) ([]string, error) {
	wWWAuthenticateIV := hdr
...
// bindHeaderDeleteRouterUnauthorized binds the response header WWW-Authenticate
func (o *DeleteRouterUnauthorized) bindHeaderWWWAuthenticate(hdr string, formats strfmt.Registry) ([]string, error) {
	wWWAuthenticateIV := hdr
...
// bindHeaderDeleteRouterConflict binds the response header WWW-Authenticate
func (o *DeleteRouterConflict) bindHeaderWWWAuthenticate(hdr string, formats strfmt.Registry) ([]string, error) {
	wWWAuthenticateIV := hdr
...
// bindHeaderDeleteRouterTooManyRequests binds the response header WWW-Authenticate
func (o *DeleteRouterTooManyRequests) bindHeaderWWWAuthenticate(hdr string, formats strfmt.Registry) ([]string, error) {
	wWWAuthenticateIV := hdr
...
// bindHeaderDeleteRouterServiceUnavailable binds the response header WWW-Authenticate
func (o *DeleteRouterServiceUnavailable) bindHeaderWWWAuthenticate(hdr string, formats strfmt.Registry) ([]string, error) {
	wWWAuthenticateIV := hdr
