...
// bindHeaderUpdateRouterOK binds the response header WWW-Authenticate
func (o *UpdateRouterOK) bindHeaderWWWAuthenticate(hdr string, formats strfmt.Registry) ([]string, error) {
...
// bindHeaderUpdateRouterBadRequest binds the response header WWW-Authenticate
func (o *UpdateRouterBadRequest) bindHeaderWWWAuthenticate(hdr string, formats strfmt.Registry) ([]string, error) {
	wWWAuthenticateIV := hdr
...
// bindHeaderUpdateRouterUnauthorized binds the response header WWW-Authenticate
func (o *UpdateRouterUnauthorized) bindHeaderWWWAuthenticate(hdr string, formats strfmt.Registry) ([]string, error) {
	wWWAuthenticateIV := hdr
...
// bindHeaderUpdateRouterNotFound binds the response header WWW-Authenticate
func (o *UpdateRouterNotFound) bindHeaderWWWAuthenticate(hdr string, formats strfmt.Registry) ([]string, error) {
	wWWAuthenticateIV := hdr
...
// bindHeaderUpdateRouterTooManyRequests binds the response header WWW-Authenticate
func (o *UpdateRouterTooManyRequests) bindHeaderWWWAuthenticate(hdr string, formats strfmt.Registry) ([]string, error) {
	wWWAuthenticateIV := hdr
...
// bindHeaderUpdateRouterServiceUnavailable binds the response header WWW-Authenticate
func (o *UpdateRouterServiceUnavailable) bindHeaderWWWAuthenticate(hdr string, formats strfmt.Registry) ([]string, error) {
	wWWAuthenticateIV := hdr
