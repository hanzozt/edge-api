...
func (o *FixDataIntegrityReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// bindHeaderFixDataIntegrityAccepted binds the response header WWW-Authenticate
func (o *FixDataIntegrityAccepted) bindHeaderWWWAuthenticate(hdr string, formats strfmt.Registry) ([]string, error) {
...
// bindHeaderFixDataIntegrityUnauthorized binds the response header WWW-Authenticate
func (o *FixDataIntegrityUnauthorized) bindHeaderWWWAuthenticate(hdr string, formats strfmt.Registry) ([]string, error) {
	wWWAuthenticateIV := hdr
...
// bindHeaderFixDataIntegrityTooManyRequests binds the response header WWW-Authenticate
func (o *FixDataIntegrityTooManyRequests) bindHeaderWWWAuthenticate(hdr string, formats strfmt.Registry) ([]string, error) {
	wWWAuthenticateIV := hdr
