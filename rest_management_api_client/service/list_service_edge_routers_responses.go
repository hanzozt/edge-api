...
// bindHeaderListServiceEdgeRoutersServiceUnavailable binds the response header WWW-Authenticate
func (o *ListServiceEdgeRoutersServiceUnavailable) bindHeaderWWWAuthenticate(hdr string, formats strfmt.Registry) ([]string, error) {
	wWWAuthenticateIV := hdr
