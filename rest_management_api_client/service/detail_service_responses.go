...
// bindHeaderDetailServiceOK binds the response header WWW-Authenticate
func (o *DetailServiceOK) bindHeaderWWWAuthenticate(hdr string, formats strfmt.Registry) ([]string, error) {
...
// bindHeaderDetailServiceUnauthorized binds the response header WWW-Authenticate
func (o *DetailServiceUnauthorized) bindHeaderWWWAuthenticate(hdr string, formats strfmt.Registry) ([]string, error) {
	wWWAuthenticateIV := hdr
...
// bindHeaderDetailServiceNotFound binds the response header WWW-Authenticate
func (o *DetailServiceNotFound) bindHeaderWWWAuthenticate(hdr string, formats strfmt.Registry) ([]string, error) {
	wWWAuthenticateIV := hdr
...
// bindHeaderDetailServiceTooManyRequests binds the response header WWW-Authenticate
func (o *DetailServiceTooManyRequests) bindHeaderWWWAuthenticate(hdr string, formats strfmt.Registry) ([]string, error) {
	wWWAuthenticateIV := hdr
...
// bindHeaderDetailServiceServiceUnavailable binds the response header WWW-Authenticate
func (o *DetailServiceServiceUnavailable) bindHeaderWWWAuthenticate(hdr string, formats strfmt.Registry) ([]string, error) {
	wWWAuthenticateIV := hdr
