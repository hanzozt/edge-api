...
// bindHeaderDetailSessionTooManyRequests binds the response header WWW-Authenticate
func (o *DetailSessionTooManyRequests) bindHeaderWWWAuthenticate(hdr string, formats strfmt.Registry) ([]string, error) {
	wWWAuthenticateIV := hdr
...
// bindHeaderDetailSessionServiceUnavailable binds the response header WWW-Authenticate
func (o *DetailSessionServiceUnavailable) bindHeaderWWWAuthenticate(hdr string, formats strfmt.Registry) ([]string, error) {
	wWWAuthenticateIV := hdr
